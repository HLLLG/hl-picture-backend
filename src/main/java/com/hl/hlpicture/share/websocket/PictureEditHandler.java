package com.hl.hlpicture.share.websocket;
...
import com.hl.hlpicture.share.websocket.disruptor.PictureEditEventProducer;
import com.hl.hlpicture.share.websocket.model.PictureEditActionEnum;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void handleEditSaveMessage(PictureEditRequestMessage pictureEditRequestMessage, WebSocketSession session,
        ...
        if (editUserId != null && editUserId.equals(user.getId())) {
            ...
            pictureEditResponseMessage.setUser(userApplicationService.getUserVO(user));
            pictureEditResponseMessage.setPicture(pictureApplicationService.getPictureVO(pictureApplicationService.getById(pictureId)));
            // 广播给用一张图片的用户
            this.broadcastToPicture(pictureId, pictureEditResponseMessage);
        }
    }
